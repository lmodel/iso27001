...
linkml_meta = LinkMLMeta({'annotations': {'aligned_standard': {'tag': 'aligned_standard',
     ...
     'description': 'A comprehensive LinkML schema modeling the requirements, '
                    'clauses, and Annex A controls of ISO/IEC 27001:2022. Designed '
                    'for open data publication, automated validation, and '
                    ...
                    '(Clause 6.1) - All 93 Annex A controls organized by domain - '
                    'Audit, measurement, and continual improvement artifacts',
     'id': 'https://w3id.org/lmodel/iso-iec-27001',
     ...
     'prefixes': {'dcterms': {'prefix_prefix': 'dcterms',
                  ...
                  'iso27001': {'prefix_prefix': 'iso27001',
                               'prefix_reference': 'https://w3id.org/lmodel/iso-iec-27001/'},
                  'iso27002': {'prefix_prefix': 'iso27002',
                               'prefix_reference': 'https://w3id.org/lmodel/iso-iec-27002/'},
     ...
     'subsets': {'annex_a_controls': {'annotations': {'control_count': {'tag': 'control_count',
                                      ...
                                      'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
                 ...
                 'isms_core': {'comments': ['Mandatory for any ISO 27001 '
                                            'conformance dataset',
                                            'Maps to "shall" requirements in the '
                                            'standard'],
     ...
     'title': 'ISO/IEC 27001:2022 Information Security Management System Schema',
...
class DocumentedInformation(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True,
         ...
         'comments': ['Per 7.5.2, documented information shall have appropriate '
                      'identification',
                      'Per 7.5.3, shall be controlled for availability and protection'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
    ...
    classification: Optional[str] = Field(default=None, description="""Information classification level.""", json_schema_extra = { "linkml_meta": {'comments': ['Per A.5.12, classification based on confidentiality, integrity, '
         ...
         'examples': [{'value': 'confidential'},
                      {'value': 'internal'},
                      {'value': 'public'}]} })
    retention_period: Optional[str] = Field(default=None, description="""Duration for which the document must be retained.""", json_schema_extra = { "linkml_meta": {'comments': ['Per 7.5.3 f) retention and disposition',
...
class InformationSecurityManagementSystem(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '4.4'},
         ...
         'comments': ['This is the root entity for any ISMS conformance dataset',
                      'Per Clause 4.4, includes processes needed and their '
                      'interactions',
                      'Scope must be documented per 4.3'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core']})
    ...
    scope_statement: Optional[str] = Field(default=None, description="""Documented statement of ISMS scope per 4.3.""", json_schema_extra = { "linkml_meta": {'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '4.3'}},
         'comments': ['Must be available as documented information'],
...
class Organization(NamedEntity):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '4.1'}},
...
class InterestedParty(NamedEntity):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '4.2'}},
         'comments': ['Per 4.2, must determine relevant requirements of interested '
                      'parties',
...
class InformationSecurityPolicy(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '5.2'},
                         'mandatory': {'tag': 'mandatory', 'value': 'true'}},
         'comments': ['Must be appropriate to purpose of organization',
                      'Must include commitment to satisfy applicable requirements',
                      'Must include commitment to continual improvement',
                      'Must be communicated within organization and to interested '
                      'parties'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
    ...
    commitment_statements: Optional[list[str]] = Field(default=None, description="""Statements of commitment included in the policy.""", json_schema_extra = { "linkml_meta": {'comments': ['Must include commitment to satisfy requirements per 5.2 c)',
                      'Must include commitment to continual improvement per 5.2 d)'],
...
class Role(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '5.3'}},
         'comments': ['Top management must assign responsibility for ISMS conformance',
                      'Top management must assign responsibility for ISMS performance '
                      'reporting'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core']})
...
class InformationSecurityObjective(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '6.2'}},
         'comments': ['Must be consistent with information security policy',
                      'Must be measurable (if practicable)',
                      'Must take into account risk assessment and treatment results',
                      'Must be monitored, communicated, and updated as appropriate'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core']})
    ...
    metric_definition: Optional[str] = Field(default=None, description="""Definition of how the objective is measured.""", json_schema_extra = { "linkml_meta": {'comments': ['Per 6.2 b) objectives shall be measurable if practicable'],
...
class RiskAssessmentProcess(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.2'},
                         'mandatory': {'tag': 'mandatory', 'value': 'true'}},
         'comments': ['Must establish risk acceptance criteria',
                      'Must ensure repeated assessments produce consistent, valid, '
                      'comparable results',
                      'Retained as documented information per 6.1.2'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
    ...
    assessment_criteria: Optional[str] = Field(default=None, description="""Criteria for performing risk assessments.""", json_schema_extra = { "linkml_meta": {'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.2 a) 2)'}},
         'domain_of': ['RiskAssessmentProcess']} })
    assessment_methodology: Optional[str] = Field(default=None, description="""Methodology used for risk assessment.""", json_schema_extra = { "linkml_meta": {'comments': ['Must ensure consistent, valid, comparable results per 6.1.2 b)'],
         'domain_of': ['RiskAssessmentProcess']} })
...
class RiskAssessment(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '8.2'}},
         'comments': ['Performed at planned intervals or when significant changes '
                      'occur',
                      'Results must be retained as documented information'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
...
class Risk(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.2'}},
         'comments': ['Must identify risk owners per 6.1.2 c) 2)',
                      'Analyzed for consequences and likelihood per 6.1.2 d)',
                      'Evaluated against criteria and prioritized per 6.1.2 e)'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['risk_management']})
...
class RiskTreatmentProcess(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.3'},
                         'mandatory': {'tag': 'mandatory', 'value': 'true'}},
         'comments': ['Must select treatment options based on risk assessment results',
                      'Must determine necessary controls',
                      'Must compare controls with Annex A',
                      'Must produce Statement of Applicability'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['risk_management', 'documented_information']})
...
class RiskTreatmentPlan(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.3'}},
         'comments': ['Must obtain risk owner approval per 6.1.3 f)',
                      'Must obtain acceptance of residual risks per 6.1.3 f)',
                      'Implementation tracked per Clause 8.3'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['risk_management', 'documented_information'],
...
class StatementOfApplicability(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '6.1.3 d)'},
                         'mandatory': {'tag': 'mandatory', 'value': 'true'}},
         'comments': ['Must contain necessary controls from risk treatment',
                      'Must contain justification for inclusion',
                      'Must state whether controls are implemented or not',
                      'Must justify exclusion of any Annex A controls'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
...
class SecurityControl(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'annex_reference': {'tag': 'annex_reference',
         ...
         'comments': ['93 controls organized in four domains (organizational, people, '
                      ...
                      'Per NOTE 1 in 6.1.3, organizations can design controls or '
                      'identify from any source'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['annex_a_controls']})
    ...
    control_text: Optional[str] = Field(default=None, description="""Full text of the control requirement.""", json_schema_extra = { "linkml_meta": {'domain_of': ['SecurityControl']} })
    implementation_guidance: Optional[str] = Field(default=None, description="""Guidance for implementing the control.""", json_schema_extra = { "linkml_meta": {'comments': ['Typically from ISO/IEC 27002:2022'],
         'domain_of': ['SecurityControl']} })
    related_controls: Optional[list[str]] = Field(default=None, description="""Other controls related to this one.""", json_schema_extra = { "linkml_meta": {'domain_of': ['InformationSecurityObjective',
                       'SecurityControl',
                       'OperationalProcedure']} })
...
class CompetenceRecord(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '7.2'}},
         'comments': ['Competence based on education, training, or experience',
                      'Actions to acquire competence must be evaluated for '
                      'effectiveness'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core', 'documented_information']})
...
class AwarenessProgram(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '7.3'}},
         'comments': ['Personnel must be aware of IS policy',
                      'Personnel must understand their contribution to ISMS '
                      'effectiveness',
                      'Personnel must understand implications of nonconformance'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core']})
...
class CommunicationPlan(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '7.4'}},
         'comments': ['Must determine what, when, with whom, and how to communicate'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['isms_core', 'documented_information']})
...
class OperationalProcedure(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '8.1'}},
         'comments': ['Must establish criteria for processes',
                      'Must implement control in accordance with criteria'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['documented_information']})
...
class MonitoringProgram(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '9.1'}},
         'comments': ['Must determine what to monitor and measure',
                      'Methods must produce valid, comparable, reproducible results'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
...
class InternalAudit(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '9.2'}},
         'comments': ["Must determine if ISMS conforms to organization's requirements",
                      'Must determine if ISMS conforms to ISO 27001 requirements',
                      'Must determine if ISMS is effectively implemented and '
                      'maintained'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['performance_evaluation', 'documented_information']})
...
class AuditProgramme(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '9.2.2'}},
         'comments': ['Must consider process importance and previous audit results',
                      'Must define audit criteria and scope for each audit',
                      'Must ensure auditor objectivity and impartiality'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['performance_evaluation', 'documented_information']})
...
class ManagementReview(DocumentedInformation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause', 'value': '9.3'}},
         'comments': ['Must be conducted at planned intervals',
                      'Must include specified inputs per 9.3.2',
                      'Results must include decisions per 9.3.3'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['performance_evaluation', 'documented_information'],
...
class Nonconformity(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '10.2'}},
         'comments': ['Must react to control and correct the nonconformity',
                      'Must deal with consequences',
                      'Must evaluate need for action to eliminate causes'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
...
class CorrectiveAction(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'iso27001_clause': {'tag': 'iso27001_clause',
                                             'value': '10.2'}},
         'comments': ['Must be appropriate to effects of nonconformities',
                      'Effectiveness must be reviewed',
                      'May require ISMS changes'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['continual_improvement']})
...
class Asset(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'annex_a_control': {'tag': 'annex_a_control', 'value': '5.9'}},
         'comments': ['Inventory required per A.5.9',
                      'Owners must be identified',
                      'Subject to acceptable use rules per A.5.10'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['annex_a_controls']})
...
class InformationSecurityIncident(NamedEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'annex_a_control': {'tag': 'annex_a_control',
                                             'value': '5.26'}},
         'comments': ['Must be responded to per documented procedures',
                      'Knowledge gained shall improve controls per A.5.27',
                      'Evidence collection per A.5.28'],
         'from_schema': 'https://w3id.org/lmodel/iso-iec-27001',
         'in_subset': ['annex_a_controls']})
