...
# Generation date: 2026-04-07T23:21:36
# Schema: iso27001
#
# id: https://w3id.org/lmodel/iso-iec-27001
# description: A comprehensive LinkML schema modeling the requirements, clauses, and Annex A controls of ISO/IEC 27001:2022. Designed for open data publication, automated validation, and integration with governance, risk, and compliance (GRC) systems.
#   This schema captures: - ISMS lifecycle (establish, implement, maintain, improve) - Risk assessment and treatment processes (Clause 6.1) - All 93 Annex A controls organized by domain - Audit, measurement, and continual improvement artifacts
...
ISO27001 = CurieNamespace('iso27001', 'https://w3id.org/lmodel/iso-iec-27001/')
ISO27002 = CurieNamespace('iso27002', 'https://w3id.org/lmodel/iso-iec-27002/')
...
class InformationSecurityManagementSystem(NamedEntity):
    ...
    for establishing, implementing, maintaining, and continually improving information security management.
    """
    _inherited_slots: ClassVar[list[str]] = []
...
class Risk(NamedEntity):
    """
    An identified information security risk associated with loss of confidentiality, integrity, or availability per
    6.1.2 c).
    """
    _inherited_slots: ClassVar[list[str]] = []
...
class StatementOfApplicability(DocumentedInformation):
    """
    The Statement of Applicability (SoA) per 6.1.3 d), listing necessary controls with justification and
...
class ManagementReview(DocumentedInformation):
    """
    A management review per Clause 9.3, conducted by top management to ensure ISMS suitability, adequacy, and
    effectiveness.
    """
    _inherited_slots: ClassVar[list[str]] = []
...
class RiskLevel(EnumDefinitionImpl):
    ...
    _defn = EnumDefinition(
        name="RiskLevel",
        description="Qualitative risk rating derived from likelihood × impact analysis.",
    )
