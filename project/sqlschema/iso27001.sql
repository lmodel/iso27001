...
--     * Slot: retention_period Description: Duration for which the document must be retained.
--     * Slot: id Description: Unique identifier for this entity instance.
--     * Slot: name Description: Human-readable name or title.
--     * Slot: description Description: Detailed description of the entity.
--     * Slot: created_date Description: Date when the entity was created.
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: InformationSecurityManagementSystem Description: Top-level container representing an organization's complete ISMS per ISO 27001. Aggregates all components required for establishing, implementing, maintaining, and continually improving information security management.
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: Risk Description: An identified information security risk associated with loss of confidentiality, integrity, or availability per 6.1.2 c).
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: RiskTreatmentPlan Description: A risk treatment plan per 6.1.3 e), documenting actions to implement selected treatment options and controls.
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: StatementOfApplicability Description: The Statement of Applicability (SoA) per 6.1.3 d), listing necessary controls with justification and implementation status.
...
--     * Slot: control_text Description: Full text of the control requirement.
--     * Slot: implementation_guidance Description: Guidance for implementing the control.
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: ManagementReview Description: A management review per Clause 9.3, conducted by top management to ensure ISMS suitability, adequacy, and effectiveness.
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: CorrectiveAction Description: A corrective action per Clause 10.2 to eliminate the cause of a nonconformity and prevent recurrence.
...
--     * Slot: modified_date Description: Date when the entity was last modified.
--     * Slot: version Description: Version identifier for the entity.
-- # Class: ImprovementOpportunity Description: An opportunity for continual improvement per Clause 10.1, enhancing ISMS suitability, adequacy, or effectiveness.
